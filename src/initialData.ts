...
export const INITIAL_DAILY_TASKS: DailyTask[] = [
  // --- ZJAZD 1: SOBOTA, 22 SIERPNIA 2026 ---
  {
    id: 'dt-2208-1',
    date: 'Sobota, 22 Sierpnia 2026',
    eventDateStr: 'Sobota, 22 Sierpnia 2026',
    eventIsoDate: '2026-08-22',
    topic: 'Rozpoczęcie Roku Szkolnego i Pierwsze Słówka',
    title: '🔤 Układanie Słów z Liter',
    description: 'Dotknij kafelków z literami na ekranie telefonu i ułóż polskie słowa z lekcji 22 sierpnia!',
    type: 'spelling',
    starsReward: 15,
    spelling: [
      { id: 'sp-22-1', word: 'SYRENKA', hint: 'Symbol Warszawy z mieczem i tarczą', emoji: '🧜‍♀️' },
      { id: 'sp-22-2', word: 'WARSZAWA', hint: 'Stolica Polski nad rzeką Wisłą', emoji: '🏰' },
      { id: 'sp-22-3', word: 'WISŁA', hint: 'Najdłuższa rzeka w Polsce', emoji: '🌊' },
      { id: 'sp-22-4', word: 'ORZEŁ', hint: 'Biały ptak w godle Polski', emoji: '🦅' },
      { id: 'sp-22-5', word: 'FLAGA', hint: 'Biało-czerwona flaga Polski', emoji: '🇵🇱' },
    ],
  },
  {
    id: 'dt-2208-2',
    ...
    starsReward: 15,
    spelling: [
      { id: 'sw-22-1', word: 'KRAKÓW', hint: 'Miasto ze Smoczą Jamą i Zamkiem Wawelskim', emoji: '🐉' },
      { id: 'sw-22-2', word: 'GDAŃSK', hint: 'Piękne polskie miasto nad Morzem Bałtyckim', emoji: '⚓' },
      { id: 'sw-22-3', word: 'PODRĘCZNIK', hint: 'Książka, z której uczymy się w sobotę', emoji: '📚' },
      { id: 'sw-22-4', word: 'SOBOTA', hint: 'Dzień, w którym spotykamy się w szkole w Walnut Creek', emoji: '🏫' },
    ],
  },
  {
    id: 'dt-2208-3',
    ...
    starsReward: 15,
    spelling: [
      { id: 'syl-22-1', word: 'WARSZAWA', hint: 'Stolica Polski nad rzeką Wisłą', emoji: '🏰' },
      { id: 'syl-22-2', word: 'SYRENKA', hint: 'Warszawska Syrenka z mieczem i tarczą', emoji: '🧜‍♀️' },
      { id: 'syl-22-3', word: 'KRAKÓW', hint: 'Miasto ze Smoczą Jamą', emoji: '🐉' },
      { id: 'syl-22-4', word: 'ORZEŁ', hint: 'Biały ptak w godle Polski', emoji: '🦅' },
      { id: 'syl-22-5', word: 'SOBOTA', hint: 'Dzień, w którym idziemy do szkoły', emoji: '🏫' },
      { id: 'syl-22-6', word: 'PODRĘCZNIK', hint: 'Książka do nauki czytania', emoji: '📚' },
      { id: 'syl-22-7', word: 'FLAGA', hint: 'Biało-czerwona flaga Polski', emoji: '🇵🇱' },
    ],
  },
  {
    id: 'dt-2208-4',
    ...
    description: 'Znajdź w siatce liter ukryte nazwy polskich miast i symboli z 22 sierpnia!',
    type: 'wordsearch',
    starsReward: 15,
    wordSearch: {
      words: [
  ...
  // --- ZJAZD 2: SOBOTA, 29 SIERPNIA 2026 ---
  {
    id: 'dt-2908-1',
    ...
    title: '🔤 Układanie Słów z Liter: Wakacje i Szkoła',
    description: 'Ułóż polskie słówka związane z wakacjami i nowym rokiem szkolnym!',
    type: 'spelling',
    starsReward: 15,
    spelling: [
      { id: 'sp-29-1', word: 'WAKACJE', hint: 'Letni czas odpoczynku od szkoły', emoji: '🏖️' },
      { id: 'sp-29-2', word: 'SŁOŃCE', hint: 'Świeci mocno na letnim niebie', emoji: '☀️' },
      { id: 'sp-29-3', word: 'MORZE', hint: 'Bałtyk pełen fal i muszelek', emoji: '🌊' },
      { id: 'sp-29-4', word: 'GÓRY', hint: 'Wysokie polskie Tatry z pięknymi szlakami', emoji: '⛰️' },
      { id: 'sp-29-5', word: 'ALFABET', hint: 'Wszystkie polskie litery od A do Ż', emoji: '🔤' },
      { id: 'sp-29-6', word: 'SZKOŁA', hint: 'Miejsce, gdzie spotykamy kolegów i panią nauczycielkę', emoji: '🏫' },
    ],
  },
  {
    id: 'dt-2908-2',
    ...
    eventIsoDate: '2026-08-29',
    topic: 'Alfabet i Wspomnienia z Wakacji: Pisanie i wypowiedzi ustne',
    title: '🎯 Tajne Słowo (Zgadywanka): Nowe Słówka',
    description: 'Zgadnij ukryte litery wakacyjnych i szkolnych słówek z 29 sierpnia!',
    type: 'secret_word',
    starsReward: 15,
    spelling: [
      { id: 'sw-29-1', word: 'PRZYJACIELE', hint: 'Koledzy i koleżanki z polskiej klasy', emoji: '👫' },
      { id: 'sw-29-2', word: 'ZESZYT', hint: 'Piszemy w nim starannie ołówkiem i piórem', emoji: '📓' },
      { id: 'sw-29-3', word: 'PIÓRNIK', hint: 'Mieszkają w nim kredki, gumka i nożyczki', emoji: '✏️' },
      { id: 'sw-29-4', word: 'WAKACJE', hint: 'Wspaniałe wspomnienia z lata', emoji: '🌴' },
      { id: 'sw-29-5', word: 'ALFABET', hint: 'Polskie abecadło', emoji: '🔤' },
    ],
  },
  {
    id: 'dt-2908-3',
    ...
    eventIsoDate: '2026-08-29',
    topic: 'Alfabet i Wspomnienia z Wakacji: Pisanie i wypowiedzi ustne',
    title: '🧩 Układanka Sylabowa: Wakacje i Alfabet',
    description: 'Połącz sylaby (np. WA-KA-CJE, SŁOŃ-CE) w całe słowa!',
    type: 'syllables',
    starsReward: 15,
    spelling: [
      { id: 'syl-29-1', word: 'WAKACJE', hint: 'Letni wypoczynek', emoji: '🏖️' },
      { id: 'syl-29-2', word: 'SŁOŃCE', hint: 'Ciepłe promienie na niebie', emoji: '☀️' },
      { id: 'syl-29-3', word: 'MORZE', hint: 'Słona woda i plaża', emoji: '🌊' },
      { id: 'syl-29-4', word: 'GÓRY', hint: 'Wysokie szczyty i lasy', emoji: '⛰️' },
      { id: 'syl-29-5', word: 'ALFABET', hint: 'Nauka czytania i pisania', emoji: '🔤' },
      { id: 'syl-29-6', word: 'SZKOŁA', hint: 'Nasza polska szkoła', emoji: '🏫' },
      { id: 'syl-29-7', word: 'ZESZYT', hint: 'Zeszyt w kratkę lub linie', emoji: '📓' },
    ],
  },
  {
    id: 'dt-2908-4',
    ...
    eventIsoDate: '2026-08-29',
    topic: 'Alfabet i Wspomnienia z Wakacji: Pisanie i wypowiedzi ustne',
    title: '🔍 Wykreślanka: Wspomnienia z Wakacji',
    description: 'Odszukaj w siatce liter słówka z lekcji 29 sierpnia!',
    type: 'wordsearch',
    starsReward: 15,
    wordSearch: {
      words: [
        { pl: 'WAKACJE', en: 'Vacation' },
        { pl: 'SŁOŃCE', en: 'Sun' },
        { pl: 'MORZE', en: 'Sea' },
        { pl: 'GÓRY', en: 'Mountains' },
        { pl: 'ALFABET', en: 'Alphabet' },
        { pl: 'SZKOŁA', en: 'School' },
      ],
      gridSize: 8,
    },
